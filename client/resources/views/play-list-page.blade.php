    ...
    <body>
        ...
        <div class="p-9">
            <table class="table w-full">
                <thead class="border-b border-[#A2A2A2] text-spotifyCardDescription">
                    <tr>
                        <th class="max-w-[10px] font-normal text-left p-3 ps-5">#</th>
                        <th class="max-w-auto font-normal text-left p-3">Title</th>
                        <th class="max-w-auto font-normal text-left p-3">Album</th>
                        <th class="max-w-auto font-normal text-left p-3">Date added</th>
                        <th class="max-w-auto font-normal text-left p-3">Duration</th>
                        <th class="min-w-[20px] font-normal text-center p-3 flex items-center justify-center">
