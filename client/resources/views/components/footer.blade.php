    ...
    <div class="w-full sm:px-9 px-4 lg:py-8">
        <div class="md:flex md:justify-between">
            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 md:justify-between">
                ...
                <div>
                    ...
                    <ul class="text-gray-500 dark:text-gray-400 font-medium">
                        <li class="mb-4">
                            <a href="https://github.com/bibookss/spotify-downloader-web-app.git"
            ...
            <div class="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
                <a href="#" class="text-gray-500 hover:text-spotifyGreen dark:hover:text-white card-animation">
                ...
                <a href="https://github.com/bibookss/spotify-downloader-web-app.git" class="text-gray-500 hover:text-spotifyGreen dark:hover:text-white card-animation">
                    <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                        viewBox="0 0 20 20">
                        <path fill-rule="evenodd"
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/"
                    class="hover:underline">Big O Team</a>. All Rights Reserved.
            </span>
