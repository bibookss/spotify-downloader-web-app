...
<nav class="spotify-navbar top-0 fixed w-screen z-20 spotify-navbar" id="navbar">
    ...
    <div class="flex md:order-2">
      <button type="button" data-collapse-toggle="navbar-search" aria-controls="navbar-search" aria-expanded="false" class="md:hidden text-gray-300 rounded-lg text-sm p-2.5 mr-1" >
      ...
      <div class="relative hidden md:block">
        ...
        <input type="text" id="search-navbar" class="block w-full p-2 pl-10 text-sm text-white border border-[#888888] rounded-lg bg-[#312828] focus:ring-gray-300 focus:border-gray-300 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search...">
      </div>
      ...
      <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-search">
        <div class="relative mt-3 md:hidden">
          ...
          <input type="text" id="search-navbar" class="block w-full p-2 pl-10 text-sm text-white border border-[#888888] bg-[#312828] rounded-lg focus:ring-gray-300 focus:border-gray-300" placeholder="Search...">
        </div>
      </div>
    </div>
</nav>
